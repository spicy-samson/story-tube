<template>
  ...
  >
    ...
    <div class="relative z-10 mx-1 mt-20 overflow-hidden rounded-[2rem] border border-white/35 bg-white/12 p-2 shadow-[0_28px_80px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.38)] backdrop-blur-xl">
    ...
    <footer class="absolute bottom-5 right-5 z-10">
      <div class="rounded-full  border-white/25 bg-white/14 px-4 py-2 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.3)] backdrop-blur-md">
